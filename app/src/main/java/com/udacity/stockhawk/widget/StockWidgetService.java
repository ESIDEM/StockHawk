...
import com.udacity.stockhawk.util.CurrencyUtil;
...
public class StockWidgetService extends RemoteViewsService {
    ...
    private class StockWidgetViewFactory implements RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            String price = CurrencyUtil.dollarFormat.format(cvs.getAsFloat(Contract.Quote.COLUMN_PRICE));
            ...
            remoteViews.setTextViewText(R.id.change, CurrencyUtil.percentageFormat.format(percentageChange/100));

            Intent fillInIntent = new Intent(mContext, StockDetailsActivity.class);
            fillInIntent.putExtra(StockDetailsActivity.STOCK_SYMBOL, symbol);
